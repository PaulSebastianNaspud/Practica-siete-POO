...
public class Main {
    public static void main(String[] args) {
        ...
        cantanteDAO.create(new Cantante("Paul", GeneroMusical.ROCK_METAL, 25, 2, 100, "Paul1", "Naspud1", 19, 0.25, Nacionalidad.CANADA));
        ...
        Cantante cantante = cantanteDAO.read(100);
        cantanteDAO.createDisco(cantante, 9, "BAD BUNNY", 2016);
        cantante = cantanteDAO.read(100);
